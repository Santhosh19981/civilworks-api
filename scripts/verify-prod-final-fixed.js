...
async function verify() {
    const logFile = 'D:\\Civil works applicaitons\\civilworks-api\\sync_verify_final.txt';
    const log = (msg) => {
        console.log(msg);
        fs.appendFileSync(logFile, msg + '\n');
    };

    fs.writeFileSync(logFile, '--- VERIFICATION SCRIPT START ---\n');
    ...
    try {
        ...
        log('Verification failed: ' + error.stack);
    }
}
